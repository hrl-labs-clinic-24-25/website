...
- **Custom Front Panel**: Link the detail instruction of front panel design/how to order them 
- **Assemble Picture**: 
...
- **Function**: 
- **Key Components**: 
- **PCB Info**: Link to the PCB design that we documented in the webiste
  - Designed in Kicad
  - Power: 
...
- **Mechanical Design**
    ...
    - Support panel link: 
    - Instruction for Hole saw original back panel
- **Assmbled Picture**:
